        ...
        for yuzong in id2:
            ...
            if len(nmf)<6:
                if len(frs)<3:
                    ...
                    pwv.append(frs+'22')
                    pwv.append(frs+'222')
                    pwv.append(frs+'সাদিয়া)
                    pwv.append(frs+'মেহজাবিন)
                    pwv.append(frs+'রিয়া'০০)
                    ...
                    pwv.append(frs+'018')
                    pwv.append(frs+'khan')
                    pwv.append(frs+'আপনাকে ভালোবাশি')
                ...
                if len(frs)<3:
                    ...
                    pwv.append(frs+'1122')
                    pwv.append(frs+'11')
                    pwv.append(frs+'রিফাত')
                    pwv.append(frs+'33')
                    pwv.append(frs+'৯৯৯')
                    pwv.append(frs+'22')
                    pwv.append(frs+'১২৩')
                    pwv.append(frs+'তাসফিয়া')
                    pwv.append(frs+'khan')
                    pwv.append(frs+'hosen')
                    pwv.append(frs+'রিদয়')
                    pwv.append(frs+'আকাশ১২৩')
                    pwv.append(frs+'khan')
                    pwv.append(frs+'019')
                    pwv.append(frs+'017')
                    pwv.append(frs+'016')
